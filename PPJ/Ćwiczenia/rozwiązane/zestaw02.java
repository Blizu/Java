public class S16710_zestaw02 {
    ...
    public static void cwiczenie_06(){
        ...
        //operuję na liczbach całkowitych, ponieważ x jest intem
        if (x == 0 || x == 1)
            System.out.println(x+" należy do zbioru C");
        else if(x>1)
            System.out.println(x+" należy do zbioru A");
        else
            System.out.println(x +" należy do zbioru B");
        System.out.println();
    }
    ...
    public static void cwiczenie_07(){
        ...
        if(wrt==-4 || wrt==-3)
            System.out.println(wrt+" należy do część wspólnej zbiorów A, B i C");
        else
            System.out.println(wrt+ " nie należy do części wpólnej zbiorów A, B i C");
        System.out.println();
    }
    public static void cwiczenie_08(){
        ...
        if(-15>wrt)
            ...
            System.out.println(wrt+" nie należy do żadnego ze zbiorów");
    }
}
